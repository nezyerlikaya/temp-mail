...
class UpdateBlogPostRequest extends FormRequest
{
    ...
    {
        return $this->user()?->can('admin.blog-studio.update') ?? false;
    }
    ...
    public function rules(): array
    {
        ...
        $postId = $post instanceof BlogPost ? $post->id : null;
        ...
        return [
            ...
            'slug' => [
                ...
                'max:120',
                'regex:/^[a-z0-9]+(?:-[a-z0-9]+)*$/',
                Rule::unique('blog_posts', 'slug')->where('locale_id', $localeId)->ignore($postId),
            ],
