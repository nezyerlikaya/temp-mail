...
class TranslationSourceRegistry
{
    ...
    public function sources(): array
    {
        return [
            ...
            $this->source('navigation', 'nav.blog', 'Blog', 'Public blog navigation label.', 'short_text', true, 30),
            $this->source('public_blog', 'blog.index.title', 'Blog', 'Public blog index title.', 'short_text', true, 10),
            $this->source('public_blog', 'blog.index.description', 'Privacy, security, and temporary email guidance.', 'Public blog index description.', 'long_text', true, 20),
            $this->source('public_blog', 'blog.empty.title', 'No articles yet', 'Public blog empty state title.', 'short_text', true, 30),
            $this->source('public_blog', 'blog.empty.body', 'Published articles for this language will appear here.', 'Public blog empty state body.', 'long_text', true, 40),
            $this->source('public_blog', 'blog.read_more', 'Read article', 'Blog card action label.', 'short_text', true, 50),
            $this->source('public_blog', 'blog.related.title', 'Related articles', 'Related posts section title.', 'short_text', true, 60),
            $this->source('public_blog', 'blog.comments.title', 'Comments', 'Public comments section title.', 'short_text', true, 70),
            $this->source('public_blog', 'blog.comments.name', 'Name', 'Public comment name field label.', 'short_text', true, 80),
            $this->source('public_blog', 'blog.comments.email', 'Email', 'Public comment email field label.', 'short_text', true, 90),
            $this->source('public_blog', 'blog.comments.content', 'Comment', 'Public comment content field label.', 'short_text', true, 100),
            $this->source('public_blog', 'blog.comments.submit', 'Submit comment', 'Public comment submit button label.', 'short_text', true, 110),
            $this->source('public_blog', 'blog.comments.closed', 'Comments are closed for this article.', 'Closed comments status.', 'short_text', true, 120),
            $this->source('public_pages', 'page.updated', 'Updated', 'Public page updated date label.', 'short_text', true, 10),
