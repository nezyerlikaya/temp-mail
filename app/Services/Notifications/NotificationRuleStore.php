...
class NotificationRuleStore
{
    ...
    public function defaults(): array
    {
        return [
            ...
            'blocked_list_import_failed' => $this->rule('warning', ['owner', 'admin'], true, false, 'immediate', 'mail-infrastructure'),
            'blocked_list_large_change' => $this->rule('warning', ['owner', 'admin'], true, false, 'immediate', 'mail-infrastructure'),
    ...
    public function labels(): array
    {
        return [
            ...
            'blocked_list_import_failed' => 'Blocked-list import failed',
            'blocked_list_large_change' => 'Blocked-list large change',
