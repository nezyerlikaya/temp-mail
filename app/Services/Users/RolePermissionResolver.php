    ...
    public function abilityMap(): array
    {
        return [
            ...
            'Content' => [
                ...
                'admin.blog-studio.publish' => 'Publish blog post readiness',
                'admin.blog-studio.trash' => 'Trash or restore blog post readiness',
    ...
    private function grants(): array
    {
        return [
            UserRole::Editor->value => [
                ...
                'admin.blog-studio.publish', 'admin.blog-studio.trash', 'admin.taxonomy.view',
            ...
            UserRole::Author->value => [
                ...
                'admin.blog-studio.update', 'admin.taxonomy.view', 'admin.taxonomy.attach', 'admin.page-studio.view',
