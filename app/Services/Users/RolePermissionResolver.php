    ...
    public function abilityMap(): array
    {
        return [
            ...
            'Content' => [
                ...
                'admin.comment-moderation.moderate' => 'Moderate comments',
                'admin.comment-moderation.approve' => 'Approve comments',
                'admin.comment-moderation.spam' => 'Mark comments as spam',
                'admin.comment-moderation.reply' => 'Reply to comments',
                'admin.comment-moderation.edit' => 'Edit comments',
                'admin.comment-moderation.trash' => 'Trash or restore comments',
                'admin.comment-moderation.delete' => 'Permanently delete comments',
                'admin.comment-moderation.blocklist' => 'Manage comment blocklist',
                'admin.comment-moderation.settings' => 'Update comment settings',
            ...
            'Mail Infrastructure' => [
                ...
                'admin.imap-smtp.manage' => 'Create or update inbound mail connections',
                'admin.imap-smtp.test' => 'Test inbound mail connections',
                'admin.imap-smtp.status' => 'Activate or deactivate inbound mail connections',
                'admin.imap-smtp.smtp.manage' => 'Create or update SMTP connections',
                'admin.imap-smtp.smtp.test' => 'Test SMTP connections',
                'admin.imap-smtp.smtp.send-test' => 'Send SMTP test emails',
                'admin.imap-smtp.smtp.default' => 'Set default SMTP connection',
            ...
            'Growth' => [
                ...
                'admin.plans-memberships.memberships.view' => 'View memberships',
                'admin.plans-memberships.memberships.grant' => 'Grant memberships',
            ...
            'Trust' => [
                ...
                'admin.abuse-reports.review' => 'Review abuse cases',
                'admin.abuse-reports.assign' => 'Assign abuse cases',
                'admin.abuse-reports.status' => 'Update abuse case status',
                'admin.abuse-reports.sensitive' => 'View sensitive reporter information',
                'admin.abuse-reports.evidence.view' => 'View protected case evidence',
                'admin.abuse-reports.evidence.manage' => 'Manage protected case evidence',
                'admin.abuse-reports.notes' => 'Add internal abuse notes',
                'admin.abuse-reports.resolve' => 'Resolve or reject abuse cases',
                'admin.abuse-reports.lifecycle' => 'Reopen or archive abuse cases',
                'admin.abuse-reports.operational-actions' => 'Execute abuse operational actions',
    ...
    private function grants(): array
    {
        return [
            UserRole::Editor->value => [
                ...
                'admin.comment-moderation.view', 'admin.comment-moderation.moderate',
                'admin.comment-moderation.approve', 'admin.comment-moderation.spam',
            ...
            UserRole::Moderator->value => [
                ...
                'admin.comment-moderation.reply', 'admin.comment-moderation.edit',
                'admin.comment-moderation.trash',
                'admin.blocked-lists.view', 'admin.domains.view',
                ...
                'admin.abuse-reports.evidence.view', 'admin.abuse-reports.notes',
                'admin.abuse-reports.resolve', 'admin.abuse-reports.lifecycle',
